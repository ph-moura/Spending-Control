#############################################################################
# Makefile for building: spending_control
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  Spending-Control_dev.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Spending-Control.pro
#############################################################################
...
CFLAGS        = -pipe -O2 -Wall -std=c++17 -Wextra -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -Wall -std=c++17 -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = spending_control1.0.0
DISTDIR = /home/paulo/Projects/Spending-Control/.tmp/spending_control1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Spending-Control.pro includes.hpp \
		income.h \
		insert_data.h \
		investments.h \
		menu.h \
...
spending_control:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Spending-Control.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		Spending-Control.pro
	$(QMAKE) -o Makefile Spending-Control.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents includes.hpp income.h insert_data.h investments.h menu.h settings.h show_data.h spendings.h window.h $(DISTDIR)/
	$(COPY_FILE) --parents income.cpp insert_data.cpp investments.cpp main.cpp menu.cpp qrc_resources.cpp settings.cpp show_data.cpp spendings.cpp window.cpp $(DISTDIR)/
...
income.o: income.cpp includes.hpp \
		income.h \
		window.h \
		insert_data.h \
		show_data.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o income.o income.cpp

insert_data.o: insert_data.cpp includes.hpp \
		insert_data.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o insert_data.o insert_data.cpp

investments.o: investments.cpp includes.hpp \
		insert_data.h \
		show_data.h \
		investments.h \
		window.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o investments.o investments.cpp
...
settings.o: settings.cpp includes.hpp \
		insert_data.h \
		settings.h \
		window.h \
		show_data.h
...
show_data.o: show_data.cpp includes.hpp \
		show_data.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o show_data.o show_data.cpp

spendings.o: spendings.cpp includes.hpp \
		insert_data.h \
		show_data.h \
		spendings.h \
		window.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o spendings.o spendings.cpp

window.o: window.cpp includes.hpp \
		window.h \
		insert_data.h \
		show_data.h
